#!/usr/bin/env python3
"""
Specialized Deepseek IA3 retraining script with strict JSON output constraints.
This script retrains the Deepseek IA3 adapter with:
...
print("=" * 70)
print("DEEPSEEK IA3 JSON RETRAINING")
print("=" * 70)
print(f"Model: {MODEL_ID}")
print(f"Adapter type: IA3")
...
# IA3 Configuration
# IA3 is more parameter-efficient than LoRA
...
print(f"- IA3 adapter configuration")
...
print(f"4. Test with: python3 debug_deepseek_ia3.py")
